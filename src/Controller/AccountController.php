...
{
    public $uses = array('Event', 'Issue', 'Token');
    ...
    public function beforeFilter(EventInterface $event): void
    {
        ...
        $this->Authentication->allowUnauthenticated(['login','lost_password','register','activate']);
...
//        }
    ...
    {
        echo Configure::read('App.defaultLocale');
        if( $this->getRequest()->is('post') === true )
        {
            $result = $this->Authentication->getResult();
            if ($result->isValid() === true)
            {
                $redirect = $this->getRequest()->getQuery('back_url', [
                    'controller' => 'Welcome',
                    'action' => 'index',
                ]);
