...
class AppController extends Controller
{
     ...
     */
    protected ProjectsTable|Table $Projects;

    /**
     * @var SettingsTable|Table
     */
    protected SettingsTable|Table $Settings;

    /**
     * @var AuthenticationComponent|Component
     */
    protected AuthenticationComponent|Component $Authentication;
    ...
    /**
     * @var CandyCaneIdentity|null
     */
    protected CandyCaneIdentity|null $currentUser;
...
//        $this->_setUrlParam();
        ...
        //
        $this->theme = strtolower( Configure::read('CandyCane.ui_theme') );
...
//        $this->_authorize();
     ...
     * @return bool
     */
    protected function isLoggIn(): bool
    {
